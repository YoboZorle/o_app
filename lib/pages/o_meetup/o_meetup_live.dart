      ...
      body: Stack(
        children: <Widget>[
          new Container(
            ...
            child: new FlareActor("assets/flare/bg_oapp.flr", fit: BoxFit.fill),
          ),
          new Container(
            margin: EdgeInsets.only(top: 45),
            decoration: new BoxDecoration(),
            child: new FlareActor("assets/flare/live_bg.flr", fit: BoxFit.fill),
          ),
          Positioned(
            top: 0,
            right: 0,
...
//          SvgPicture.asset(_live_bg, // Bright shade at the top
...
//                                          fit: BoxFit.cover,
//                                          image: NetworkImage(
//                                              'https://itedgenews.ng/wp-content/uploads/2020/01/Google-Lauch-Space.jpg')),
